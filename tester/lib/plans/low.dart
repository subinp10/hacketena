...
class low extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('low-budget',style: TextStyle(color: Colors.white),)),
        ...
        child: Container(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(height: 10,),
              ListTile(leading: CircleAvatar(radius: 35,child: Text("Hotel",style: TextStyle(fontSize: 13),)),title: Text("Plural Hotel"),subtitle: Text("Mumbai"),trailing: Text("1000 RS"),),
              SizedBox(height: 10,),
              ...
              ListTile(leading: CircleAvatar(radius: 35,child: Text("Lunch",style: TextStyle(fontSize: 13),)),title: Text("Gateway of India"),subtitle: Text("1:10pm to 2:00pm"),trailing: Text("150 RS"),),
               SizedBox(height: 10,),
              ListTile(leading: CircleAvatar(radius: 35,child: Text("Hotel",style: TextStyle(fontSize: 13),)),title: Text("Plural Hotel"),subtitle: Text("Mumbai"),trailing: Text("500 Rs"),),
              SizedBox(height: 10,),
